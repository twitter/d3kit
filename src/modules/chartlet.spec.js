...
define([
  ...
  describe('Chartlet', function(){
    ...
    var ChildChartlet = null;
    var ParentComponet = null;


    var callback = function(selection, done) {done();};
    beforeEach(function(done){
      ChildChartlet = function() {
        var chartlet = new Chartlet(callback, callback, callback);
    ...
    describe('#publishEventsTo(foreignDispatcher)', function(){
      it('should map events to a foreignDispatcher', function(done) {
        ...
        var parent = new Chartlet(callback, callback, callback, ['foo']);
